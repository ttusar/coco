...
%%
\ifthenelse{\equal{\numberofalgorithms}{one}}{
Figures~\ref{fig:ERTgraphs}, \ref{fig:ECDFs}, and \ref{fig:ECDFsingleOne} and Tables~\ref{tab:aRTs}, \ref{tab:aRTloss}, and \ref{fig:aRTlogloss}.
}{\ifthenelse{\equal{\numberofalgorithms}{two}}{
...
% evaluations) divided by the the aRT of a reference algorithm (e.g. the best
% measured aRT during BBOB-2009) as given in the first row of each cell
...
% Average running time (aRT in number of function evaluations)
% divided by the aRT of a potential reference algorithm (e.g. the best aRT
