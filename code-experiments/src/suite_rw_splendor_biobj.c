 ...
 */
static coco_suite_t *suite_rw_splendor_biobj_initialize(void) {

  coco_suite_t *suite;
  const size_t dimensions[] = { 10 };

  suite = coco_suite_allocate("rw-splendor-biobj", 1, 1, dimensions, "instances: 1");  /* TODO */
 ...
 */
static coco_problem_t *suite_rw_splendor_biobj_get_problem(coco_suite_t *suite,
  ...
  problem = rw_splendor_problem_allocate(suite->suite_name, 2, function, dimension, instance);
  assert(problem != NULL);
