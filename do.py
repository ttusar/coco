...
def main(args):
    ...
    elif cmd == 'build-rw-top-trumps-server': build_rw_top_trumps_server(force_download=force_rw_download, port=port, batch=batch)
    elif cmd == 'build-rw-mario-gan-server': build_rw_mario_gan_server(force_download=force_rw_download, port=port)
